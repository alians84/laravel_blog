...
class PermissionTableSeeder extends Seeder
{
    ...
    {
        $permissions = [
            ['slug'=>'manage-user','name'=>'Управление пользователями'],
            ...
            ['slug'=>'manage-roles','name'=>'Управление ролями пользователя'],
            ...
            ['slug'=>'assign-permission','name'=>'Назначение прав для пользователя'],
            ...
            ['slug'=>'edit-categories','name'=>'Редактирование катигории блога'],
