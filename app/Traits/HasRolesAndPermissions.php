...
trait HasRolesAndPermissions {
    ...
    /**
     * Связь между User с моделью Permission
      */
    ...
    /**
     * имеет текущий пользоваетль роль $role?
     */
    ...
    /**
     * Имеет текущий пользователь право $permissions?
     */
    public function hasPermViaRoles($permissions){
        //смотрим все роли пользователя и ищем в них нужное право
        foreach ($this->roles as $role){
            if ($role->permissions->contains('slug',$permissions)){
                return true;
            }
        }
        return false;
    ...
    /**
     * Имеет текущий пользователь все права из $permissions либо напрямую, либо через одну из своих ролей ?
     */
